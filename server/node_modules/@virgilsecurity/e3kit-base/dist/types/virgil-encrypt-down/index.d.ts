...
declare class VirgilEncryptDown<K> extends AbstractLevelDOWN<K, ValueType> {
    ...
    _put(key: K, value: ValueType, options: AbstractOptions, callback: ErrorCallback): number | undefined;
    _del(key: K, options: AbstractOptions, callback: ErrorCallback): void;
    _batch(ops: ReadonlyArray<AbstractBatch<K, ValueType>>, options: AbstractOptions, callback: ErrorCallback): number | undefined;
