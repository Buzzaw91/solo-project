...
export declare class PrivateKeyLoader {
    ...
    savePrivateKeyRemote(privateKey: IPrivateKey, password: string): Promise<import("@virgilsecurity/keyknox/dist/types/types").CloudEntry>;
    ...
    restorePrivateKey(password: string): Promise<IPrivateKey>;
