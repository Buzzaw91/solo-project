    ...
    return {
        ...
        decrypt(encryptedData, verifyingPublicKey) {
            ...
            try {
                ...
                return dataUtils.toBuffer(session.decrypt(message, lowLevelPublicKey));
            }
            finally {
...
class VirgilCrypto {
    ...
    exportPrivateKey(privateKey) {
        ...
        try {
            const serializedPrivateKey = serializePrivateKey(lowLevelPrivateKey);
            return dataUtils.toBuffer(serializedPrivateKey);
        }
        finally {
            lowLevelPrivateKey.delete();
        }
    ...
    exportPublicKey(publicKey) {
        return dataUtils.toBuffer(publicKey.key);
    }
