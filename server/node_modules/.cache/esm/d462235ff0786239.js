let User,config,jwt;_f07‍.x([["default",()=>_f07‍.o]]);_f07‍.w("../../models/models",[["User",["User"],function(v){User=v}]]);_f07‍.w("../../config/index",[["default",["config"],function(v){config=v}]]);_f07‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);



async function action(req, res) {
  const { email, password } = req.body
  _f07‍.g.console.log(email)
